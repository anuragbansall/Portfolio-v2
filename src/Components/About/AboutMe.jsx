...
function AboutMe() {
  ...
  return (
    <div className='flex w-full gap-8'>
                    <div className='w-[30rem] flex flex-col gap-6 bg-[#101215] border border-[#373D43] p-8 rounded-2xl'>
                        <div className='flex w-full items-center gap-8'>
                            <div className='h-[6rem] w-[6rem] rounded-full bg-zinc-900'>
                                <img src={face} alt="" className='h-full w-full object-cover' />
                            </div>
                            <h2 className='font-semibold text-4xl overflow-hidden'>Anurag Bansal</h2>
                        </div>
                        <p className=''>
                    ...
                    <div className='flex-grow flex flex-col gap-4 pt-4'>
                        <div className='flex justify-between bg-[#101215] border border-[#373D43] p-8 rounded-2xl'>
                            <h2 className='font-semibold text-3xl'>RESUME</h2>
                        ...
                        <div className='flex gap-4'>
                            {
                                socialIconsPngs.map((item, idx) => (
                                    <div key={idx} className={`bg-[#101215] hover:bg-[#191b1e] border border-[#373D43] p-8 text-[3rem] rounded-2xl cursor-pointer`} onClick={() => {window.location.href = item.link}}>
                                        {
